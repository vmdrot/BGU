...
namespace BGU.DRPL.SignificantOwnership.Utility.WPFGen
{
    public class XAMLGenerator
    {
        ...
        //{
        //    
        //    //using (Stream strm = BGU.DRPL.SignificantOwnership.Utility..ResourceManager.GetStream(name))
        //    //{
        ...
        {
            //XmlNode container = xamlDoc1.DocumentElement.SelectSingleNode("//ResourceDictionary.MergedDictionaries");
        ...
        public XmlDocument Generate(Type typ, Assembly userAsmbly, Dictionary<Type, string> controlTemplateNames)
        {
            ...
            {
                XmlNode dataTemplateNode = rslt.FirstChild.ChildNodes[1];//rslt.SelectSingleNode("/ResourceDictionary/DataTemplate/Grid");
        ...
        private void AddCollectionEditControl(XmlNode container, PropertyInfo pi)
        {
            ...
            //XmlNode curr = container.OwnerDocument.CreateNode(XmlNodeType.Element, dummyNodeElementName, container.OwnerDocument.Attributes[dummyNodeElementNamespaceAttrNm].Value);
