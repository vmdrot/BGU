...
namespace BGU.DRPL.SignificantOwnership.Tester
{
    class Program
    {
        ...
        static Program()
        {
			...
			_cmdHandlers.Add("pivdennyiownershipchainparsertest", PivdennyiOwnershipChainParserTest);
            #endregion
...
RegLicAppx9BankingLicenseAppl.xsd";
		...
		#region Pivdennyi Chain
		public static string testOwnershipChain = @"
1. ПІДПРИЄМСТВО ""ТЕКОМ""(51%), якому належить 3,641833% акцій банку;
2. ПІДПРИЄМСТВО ""ТЕКОМ""(51%), якому належить 96% у ПрАТ СК ""ТЕКОМ"", якому належить
4,513480% акцій банку;
3. ПІДПРИЄМСТВО ""ТЕКОМ""(51%), якому належить 96% у ПрАТ СК ""ТЕКОМ"", якому належить
100% у ТОВ ""ХОЛДЕРМАН"", якому належить
4,513480% акцій банку;
4. ТОВ ""ІНВЕСТИЦІЙНА ПІВДЕННА КОМПАНІЯ""
(75%), якому належить 91,03% у ПАТ ЗНВКІФ ""СТРАТЕГІЧНІ ІНВЕСТИЦІЇ"", якому належить
4,102252% акцій банку;
5. ТОВ ""ЧУБІВСЬКЕ ЗЕРНО""(60,02%), якому належить 99,92% у ТОВ ""ВІЛЛА ФЛОРА"", якому належить 5,225746% акцій банку;";

		public static string testOwnershipChain2 = @"""ЕССЕТ ІНВЕСТ ІНК."" (99,9%), якій належить
99,985% ТОВ ""КАПІТАЛ"", якому належить 99,97%
ТОВ ""ТЕХНО-ІНФОРМ"", якому належить 6,717094%
акцій банку;
8. ""ЕССЕТ ІНВЕСТ ІНК."" (99,9%), якій належить
99,985% ТОВ ""КАПІТАЛ"", якому належить 98% ПрАТ
СК""ТЕКОМ-ЖИТТЯ"", якому належить 2,307914%
акцій банку. 9. ПрАТ СК ""ТЕКОМ"" (1%), якому належить
4,513480% акцій банку;
10. ПрАТ СК ""ТЕКОМ"" (1%), якому належить 100% у
ТОВ ""ХОЛДЕРМАН"", якому належить 4,513480%
акцій банку;
11. ТОВ КУА ""ТЕКОМ ЕССЕТ МЕНЕДЖМЕНТ""
(9,5%), якому належить 8,97% у ПАТ ЗНВКІФ ""СТРАТЕГІЧНІ ІНВЕСТИЦІЇ"", якому належить
4,102252% акцій банку;
12. ПІДПРИЄМСТВО ""ТЕКОМ"" (51%), якому належить 1% у ПрАТ СК ""ТЕКОМ-ЖИТТЯ"", якому належить 2,307914%;
13. КОМПАНІЯ З ІНВЕСТУВАННЯ РЕСУРСІВ, ЛТД. (незалежна від формального володіння можливість
вирішального впливу), якій належить 64,27% ТОВ
КУА ""ТЕКОМ ЕССЕТ МЕНЕДЖМЕНТ"", якому належить 8,97% у ПАТ ЗНВКІФ ""СТРАТЕГІЧНІ
ІНВЕСТИЦІЇ"", якому належить 4,102252% акцій
банку;
14. КОМПАНІЯ З ІНВЕСТУВАННЯ РЕСУРСІВ, ЛТД. (незалежна від формального володіння можливість
вирішального впливу), якій належить 64,27% ТОВ
КУА ""ТЕКОМ ЕССЕТ МЕНЕДЖМЕНТ"", якому належить 8,97% у ПАТ ЗНВКІФ ""СТРАТЕГІЧНІ
ІНВЕСТИЦІЇ"", якому належить 9,99% у ПрАТ ""АМ ""ФАРМАЦІЯ"", якому належить 99,87% у ТОВ ""ФІНГЛОБАЛ"", якому належить 3,787126% акцій
банку;";

		public static string testOwnershipChain3 = @"
15. КОМПАНІЯ З ІНВЕСТУВАННЯ РЕСУРСІВ, ЛТД. (незалежна від формального володіння можливість
вирішального впливу), якій належить 64,27% ТОВ
КУА ""ТЕКОМ ЕССЕТ МЕНЕДЖМЕНТ"", якому належить 8,97% у ПАТ ЗНВКІФ ""СТРАТЕГІЧНІ
ІНВЕСТИЦІЇ"", якому належить 24,9% у ТОВ ""ФІНФАРМ"", якому належить 41,51% у ПрАТ ""АМ ""ФАРМАЦІЯ"", якому належить 99,87% у ТОВ ""ФІНГЛОБАЛ"", якому належить 3,787126% акцій
банку;
 16. КОМПАНІЯ З ІНВЕСТУВАННЯ РЕСУРСІВ, ЛТД. (незалежна від формального володіння можливість
вирішального впливу), якій належить 64,27% ТОВ
КУА ""ТЕКОМ ЕССЕТ МЕНЕДЖМЕНТ"", якому належить 8,97% у ПАТ ЗНВКІФ ""СТРАТЕГІЧНІ
ІНВЕСТИЦІЇ"", якому належить 10,1% у ТОВ ""АПТЕКА ГАЄВСЬКОГО"", якому належить 9,49% у
ПрАТ ""АМ ""ФАРМАЦІЯ"", якому належить 99,87% у
ТОВ ""ФІНГЛОБАЛ"", якому належить 3,787126% акцій
банку;
17. КОМПАНІЯ З ІНВЕСТУВАННЯ РЕСУРСІВ, ЛТД. (здійснює вирішальний вплив на управління /
діяльність компанії незалежно від формального
володіння), якій належить 64,27% ТОВ КУА ""ТЕКОМ
ЕССЕТ МЕНЕДЖМЕНТ"", якому належить 9,99% у
ТОВ ""ФІНФАРМ"", якому належить 41,51% у ПрАТ
""АМ ""ФАРМАЦІЯ"", якому належить 99,87% у ТОВ ""ФІНГЛОБАЛ"", якому належить 3,787126% акцій
банку";
		#endregion

		public static void PivdennyiOwnershipChainParserTest(string[] args) 
		{
			PivdennyiOwnershipChainDescriptionParser rp = new PivdennyiOwnershipChainDescriptionParser();
			var res = rp.Parse(testOwnershipChain2 + testOwnershipChain3);

			XmlSerializer xmlSer = new XmlSerializer(res.GetType());

			using (FileStream fs = new FileStream(@"D:\Repos\BGUResources\Pivdennyi\Ownership.xml", FileMode.Create))
			{
				xmlSer.Serialize(fs, res);
			}
		}
	}
}
